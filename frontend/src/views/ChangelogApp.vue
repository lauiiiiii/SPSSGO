...
const changelogEntries = [
  {
    ...
    items: [
      '修了个隐藏 bug：SNK 和 Duncan 事后比较的 rank_distance 根本没传进来，一直 max(None,2)=2 在裸奔，现在老老实实算真实排序间距了',
      '新增 N 因素方差分析：两因素三因素都嫌不够？这次不限制数量了，丢几个算几个，底层 R 引擎兜底',
      '补了 R 脚本对接文档，以后 Python 调 R 不用再靠猜',
      '新方法配了测试，早挂早修不欠账',
    ],
  },
  {
