...
const changelogEntries = [
  {
    ...
    items: [
      '⚡ 核心算法突破：修复 SNK/Duncan 事后比较关键 bug，rank_distance 排名间距计算精准实现，检验效能大幅提升',
      '🚀 重磅升级：全新 N 因素方差分析引擎上线，支持任意维度因素组合，底层调用 R 引擎确保学术级精度',
      '📚 专业规范：新增 R 脚本接口对齐文档，实现 Python/R 双引擎无缝协作，数据分析能力再攀高峰',
      '✅ 质量保障：完善测试体系全面覆盖，确保每一次分析结果都经得起严苛检验',
    ],
  },
  {
    date: '2026-05-18',
