...
const changelogEntries = [
  {
    ...
    title: '信度与相关系列方法全面升级',
    items: [
      '组内相关系数 ICC：R 脚本重构，增强一致性模型选择与置信区间输出',
      'Kendall 一致性检验：新增 R 引擎支持，增强和谐系数与显著性检验',
      'Kappa 一致性检验：增强加权 Kappa 与多评分者一致性评估',
      '多维尺度分析 MDS：增强距离矩阵计算与二维空间坐标准确性',
      'Spearman 等级相关：增强非参数相关系数输出与显著性标注',
      '相关与一致性推荐：更名并增强变量特征自动识别与推荐逻辑',
      '图表系统：增强散点矩阵图与热力图渲染',
      '新增 ICC、Kendall、Kappa、MDS、Spearman 共 5 个方法完整测试',
    ],
  },
  {
    date: '2026-06-06',
