...
const changelogEntries = [
  {
    date: '2026-05-23',
    type: 'fix',
    title: '一个静默 Bug 修了，N 因素方差分析上线',
    items: [
      '如果你在 SPSSGO 跑过 SNK 或 Duncan，之前拿到的 P 值全是废的：rank_distance 从上线第一天就没传进来，检验逻辑在起点站了整整一年，今天杀了',
      'SPSS 三因素封顶，我们不是——N 因素方差分析正式上线，你丢多少自变量它就拆多少，R 引擎垫底，从此 ANOVA 没有维度天花板',
      'Python ↔ R 双引擎接口全线开源：SPSSAU 没 R、SPSSPRO 黑盒，我们直接公开协议，变量怎么传、矩阵怎么转、结果怎么吐，一行不漏',
      '全链路回归测试落地：改完代码不用靠手感，跑一条命令看红绿，核心路径退化通道已堵死',
    ],
  },
  {
    date: '2026-05-18',
