...
export const extraAnalysisChildren = [
  buildAnalysisChild('analysis-choice-mm', '选择题【多选&多选】', {
    intro: '选择题【多选&多选】适合同时比较两道多选题的联合选择结构，常用于产品组合、内容偏好或渠道搭配研究。',
    purpose: [
      '当两道题都是“可多选”的时候，你通常更关心哪些选项会被同一批受访者一起选中，以及哪些组合最常同时出现。',
    ],
    io: [
      '输入：两组多选题拆分后的 0/1 选项列，每组内部属于同一题目。',
      '输出：联合选择频次、联合选择率和组合热度排序。',
    ],
    steps: [
      { title: '选择该分析方法', text: '先在问卷类分析目录里进入“选择题【多选&多选】”。' },
...
result = pd.DataFrame(joint, columns=["题A选项", "题B选项", "联合频次"])`,
  ...
  buildAnalysisChild('analysis-choice-ms', '选择题【多选&单选】', {
    intro: '选择题【多选&单选】适合比较“不同单选人群”在多选题上的选择偏好差异。',
    purpose: [
    ...
    steps: [
      { title: '选择该分析方法', text: '进入“选择题【多选&单选】”后，先确认哪一道题负责分组、哪一道题负责看偏好。' },
...
result = pd.DataFrame(rows, columns=["组别", "选项", "选择率"])`,
  ...
  buildAnalysisChild('analysis-choice-sm', '选择题【单选&多选】', {
    intro: '选择题【单选&多选】适合从单选结果出发，分析某一单选结果对应的人群在多选题上的偏好扩展。',
    purpose: [
    ...
    steps: [
      { title: '选择该分析方法', text: '进入“选择题【单选&多选】”，明确你想先看哪个单选结果。' },
