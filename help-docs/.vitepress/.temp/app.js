...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"SPSSGO 帮助中心","description":"SPSSGO 数据分析平台帮助文档","base":"/help/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.png","siteTitle":"SPSSGO","outline":[2,3],"nav":[{"text":"产品介绍","link":"../about"},{"text":"帮助中心","link":"/"}],"sidebar":[{"text":"我的数据","link":"/my-data","items":[]},{"text":"可视化绘图","link":"/charts","items":[]},{"text":"数据处理","link":"/processing","collapsed":false,"items":[{"text":"概述","link":"/processing"},{"text":"数据标签","link":"/processing/label"},{"text":"数据编码","link":"/processing/encode"},{"text":"异常值处理","link":"/processing/outlier"},{"text":"无效样本处理","link":"/processing/invalid-sample"},{"text":"缺失值处理","link":"/processing/missing"},{"text":"数据标准化","link":"/processing/standardize"},{"text":"生成变量","link":"/processing/generate"},{"text":"虚拟变量转换","link":"/processing/dummy"},{"text":"特征筛选","link":"/processing/feature-select"},{"text":"样本均衡","link":"/processing/balance"},{"text":"缩尾/截尾处理","link":"/processing/winsorize"},{"text":"数据降维","link":"/processing/reduce"},{"text":"数据降采样","link":"/processing/downsample"},{"text":"数据变换","link":"/processing/transform"},{"text":"时序数据滑窗转换","link":"/processing/sliding-window"},{"text":"样本加权","link":"/processing/weight"}]},{"text":"数据分析","link":"/analysis","collapsed":false,"items":[{"text":"概述","link":"/analysis"},{"text":"数据概览","link":"/analysis/data-overview"},{"text":"频数分析","link":"/analysis/frequency"},{"text":"描述性统计","link":"/analysis/descriptive"},{"text":"分类汇总","link":"/analysis/category-summary"},{"text":"列联（交叉）分析","link":"/analysis/cross-tabulation"},{"text":"正态性分析","link":"/analysis/normality"},{"text":"信度分析","link":"/analysis/reliability"},{"text":"效度分析","link":"/analysis/validity"},{"text":"相关性分析","link":"/analysis/pearson"},{"text":"多选分析","link":"/analysis/multiple-choice"},{"text":"交叉表（调研专项）","link":"/analysis/survey-cross-tab"},{"text":"对应分析","link":"/analysis/correspondence"},{"text":"验证性因子分析","link":"/analysis/cfa"},{"text":"Kano模型","link":"/analysis/kano"},{"text":"独立样本T检验","link":"/analysis/independent-t"},{"text":"配对样本T检验","link":"/analysis/paired-t"},{"text":"单因素方差分析","link":"/analysis/anova"},{"text":"卡方检验","link":"/analysis/chi-square"},{"text":"多元线性回归","link":"/analysis/regression"},{"text":"中介效应分析","link":"/analysis/mediation"},{"text":"调节作用","link":"/analysis/moderation"},{"text":"多重共线性 VIF","link":"/analysis/vif"},{"text":"Spearman 等级相关","link":"/analysis/spearman"},{"text":"多维尺度分析","link":"/analysis/mds"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/lauiiiiii/spssgo"}],"footer":{"message":"基于 AGPL-3.0 开源协议发布","copyright":"© 2026 日照广泰佳和网络科技有限公司"},"search":{"provider":"local"},"docFooter":{"prev":"上一篇","next":"下一篇"},"lastUpdated":false,"editLink":false},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CMDxVzLV.js"));
